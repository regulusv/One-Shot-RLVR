...
# L4 GPU - Qwen2.5-0.5B with vLLM
# Small model that fits comfortably in 24GB GPU memory
# Expected: 15-20 min/epoch, ~10GB memory usage
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen0.5b_l4_vllm' \
