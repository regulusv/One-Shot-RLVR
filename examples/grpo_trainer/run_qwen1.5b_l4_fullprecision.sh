...
# L4 GPU (24GB VRAM) - Full Precision Training
# L4 supports bf16 and Flash Attention 2
# Memory-optimized settings for single L4 GPU
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen1.5b_l4_fullprecision' \
